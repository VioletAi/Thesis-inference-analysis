...
def visualize_runner(scene_id,pred_id,gt_id):
    pred_attrs = torch.load("/home/wa285/rds/hpc-work/Thesis/Thesis-Chat-3D-v2/annotations/scannet_mask3d_val_attributes.pt")
    gt_attrs = torch.load("/home/wa285/rds/hpc-work/Thesis/Thesis-Chat-3D-v2/annotations/scannet_val_attributes.pt")
